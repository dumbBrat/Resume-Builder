...
def build_modern_template(buffer, data):
    doc = SimpleDocTemplate(buffer, pagesize=A4, topMargin=40, bottomMargin=30, leftMargin=40, rightMargin=40)
    ...
    contact_lines = [personal_info.get("email", ""), personal_info.get("phone", ""), personal_info.get("linkedin", ""), personal_info.get("github", "")]
